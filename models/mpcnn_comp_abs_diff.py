...
class MPCNNCompAbsDiff(MPCNNVariantBase):
    ...
    def __init__(self, n_word_dim, n_holistic_filters, n_per_dim_filters, filter_widths, hidden_layer_units, num_classes, dropout, ext_feats, attention, wide_conv):
        ...
        COMP_1_COMPONENTS_HOLISTIC, COMP_1_COMPONENTS_PER_DIM, COMP_2_COMPONENTS = n_holistic_filters, self.in_channels, n_holistic_filters
        n_feat_h = 3 * (len(self.filter_widths) - 1) * COMP_2_COMPONENTS + 3
        n_feat_v = (
